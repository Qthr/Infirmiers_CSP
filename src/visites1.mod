...
int nbSoins = card(soins);                          // Le nombre de soins à administrer (+ actions démarrage et transmission cabinets))
...
// Position[2] = 3 signifie la position de l'étape 2 est l'adresse d'id 3 
dvar int Position[rEtapes] in rAdresse;
// Transition[2] = 134 signifie la durée de transition pour passer de l'étape 2 à l'étape 3 est 134 minutes                          
dvar int Transition[rEtapes] in 0..dureeMaxTransition;          
// Action[2] = 5 signifique l'action réalisée à l'étape 2 est l'admibistration des soins d'id 5
dvar int Action[rEtapes] in rSoin;                              
